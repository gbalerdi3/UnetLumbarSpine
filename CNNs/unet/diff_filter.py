...
ax.set_xlabel('N° Filtros')

ax.set_ylim(0.90, 1)  # Set the lower and upper bounds of the y-axis
...
plt.savefig(datapath + 'FilterDiff.tiff')
ax.set_ylim(0, 1)
plt.savefig(datapath + 'FilterDiffBigScale.tiff')
